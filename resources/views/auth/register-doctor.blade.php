        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('doctor_register') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('public') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="radio-inline"><input id="public" type="radio"  name="public" value="1" required autofocus>public</label>
                                <label class="radio-inline"><input id="public" type="radio"  name="public" value="0" >private</label>
